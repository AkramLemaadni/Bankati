...
<head>
    ...
    <style>
        ...
        .form-control:focus, .form-select:focus {
            border-color: #a084e8;
            box-shadow: 0 0 0 0.2rem rgba(160,132,232,.15);
            background: #232526;
            color: #fff;
        }
        .input-group-text {
        ...
        .footer-navbar .text-muted, .footer-navbar .purple {
...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center" href="<%= ctx %>/home">
            ...
            <strong class="purple ml-1"><%=application.getAttribute("AppName")%> <span class="admin-badge">ADMIN</span></strong>
        </a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link text-primary fw-bold active" href="<%= ctx %>/credit">
                        <i class="bi bi-cash-stack me-1"></i> Gestion Crédits
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-primary fw-bold" href="<%= ctx %>/users">
                        <i class="bi bi-people me-1"></i> Gestion Utilisateurs
                    </a>
                </li>
            </ul>
        </div>
...
<div class="main-card mt-5 mb-5">
    ...
    <!-- FILTER OPTIONS -->
    <div class="mb-4 p-3 rounded-3" style="background: #212529;">
...
<nav class="navbar footer-navbar fixed-bottom shadow-sm">
    <div class="container d-flex justify-content-between align-items-center w-100">
        <span class="text-muted small"><b class="purple"><i class="bi bi-house-door me-1"></i> <%=application.getAttribute("AppName")%> 2025 </b>– © Tous droits réservés</span>
    </div>
</nav>
