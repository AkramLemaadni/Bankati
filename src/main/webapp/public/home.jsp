...
<head>
	<meta charset="UTF-8">
	<title>Accueil - <%= application.getAttribute("AppName") %></title>
	<link rel="stylesheet" href="<%= request.getContextPath() %>/assets/css/bootstrap.min.css">
	<link rel="stylesheet" href="<%= request.getContextPath() %>/assets/css/bootstrap-icons.css">
    ...
    <nav class="nav flex-column">
        ...
        <div class="dropdown">
            <a class="nav-link dropdown-toggle text-success" href="#" data-bs-toggle="dropdown">
                ...
                <%= user.getRole() %>: <%= user.getFirstName() %>
            </a>
...
<div class="main-content">
    <div class="main-card">
        ...
        <% } %>
        <% } else { %>
        <h1 class="mt-4 mb-3 text-danger font-weight-bold text-capitalize text-center">
